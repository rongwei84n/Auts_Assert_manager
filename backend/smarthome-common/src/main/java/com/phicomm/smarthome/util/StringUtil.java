package com.phicomm.smarthome.util;
...
public class StringUtil {
	...
	public static boolean isMobile(final String agent) {
		if (agent.contains("phicomm mobile")) {
			return true;
		}

		if (agent.contains("phicomm pc")) {
			return false;
		}

		if (agent.contains("android") || agent.contains("iphone") || agent.contains("windows ce")
				|| agent.contains("windows mobile") || agent.contains("ipad")) {
			return true;
		}
